...
{
	$insData = $conn->query("INSERT INTO examinee_tbl(exmne_fullname,exmne_course,exmne_gender,exmne_year_level,exmne_email,exmne_password) VALUES('$fullname','$course',$gender','$year_level','$email','$password')  ");
	if($insData)
	{
