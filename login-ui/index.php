...
<html lang="en">
<head>
	<title>FirstGenius Student LOGIN</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="shortcut icon"  href="assets/images/genius.png"/>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title " style="background-image: url(login-ui/images/bg-01.jpg);">
					<span class="login100-form-title-1" style="margin-bottom: 10px;">
						Student Sign In
					</span>

					<img src="assets/images/genius.png" alt="" width='100px' height='100px' style='position: absolute; top: 10px; left: 0;'>
				</div>
				...
				<form method="post" id="examineeLoginFrm" class="login100-form validate-form">
					...
					<div class="container-login100-form-btn" align="right">
						<button type="submit" class="login100-form-btn" style='background-color: #3f6ad8;'>
							Login
						</button>
					</div>
				</form>
